...
import pandas as pd
import time
from selenium import webdriver                  # selenium.webdriver controls web browsers programmatically
from selenium.webdriver.common.by import By     # By helps locate elements on a web page
